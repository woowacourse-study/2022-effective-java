...
- [x] 5. 자원을 직접 명시하지 말고 의존 객체 주입을 사용하라	(매트)
- [ ] 6. 불필요한 객체 생성을 피하라	
- [ ] 7. 다 쓴 객체 참조를 해제하라	
...
- [x] 37. ordinal 인덱싱 대신 EnumMap을 사용하라	(티키)
...
- [ ] 57. 지역변수의 범위를 최소화하라	
- [x] 58. 전통적인 for 문보다는 for-each 문을 사용하라	(썬)
- [ ] 59. 라이브러리를 익히고 사용하라	
